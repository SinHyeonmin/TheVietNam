    ...
    <div className='Customer' style={{ backgroundColor: '#EEEEEE' }}>
      ...
      >
        ...
        >
          ...
          >
            <div class='div_style'>
              <label htmlFor='form_type1' class='label_style'>
            ...
            <div class='div_style'>
              <label htmlFor='visit_day' class='label_style'>
                방문일
            ...
            <div class='div_style'>
              ...
              <select
                ...
                id='form_pay_time'
                name='form_pay_time'
                style={{ marginLeft: '10px', width: '100px', height: '25px' }}
              >
            ...
            <div class='div_style'>
              <label htmlFor='order_menu' class='label_style'>
                주문메뉴
              </label>
              <input
                type='text'
            ...
            <div style={{ marginTop: '10px' }}>
              <label htmlFor='' class='label_style'>
            ...
            <div>
              <div className='div_style'>
                ...
                <label htmlFor='sms_answer' class='label_style'>
                  <input
                    name='form_answer'
                    value='문자 답변'
                    type='radio'
                ...
                <label htmlFor='em_answer' class='label_style'>
                  <input
                    name='form_answer'
                    value='이메일 답변'
                    type='radio'
            ...
            <div class='div_style'>
              <label htmlFor='form_title' class='label_style'>
            ...
            <div class='content' style={{ marginTop: '10px' }}>
              <label htmlFor='form_content' class='label_style'>
                내용<span style={{ color: 'red', marginTop: '20px' }}> * </span>
              </label>
              <textarea
                name='form_content'
                id='form_content'
              ...
              >
                현재{' '}
                <span id='xWordCnt' className='now'>
                  {wordCount}
                </span>{' '}
                / 최대 4000byte (한글 2000자, 영문 4000자)
              </span>
            </div>
          </div>
          <div
